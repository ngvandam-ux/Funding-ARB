...
--
-- Replace <project-ref> with the real project ref (efsaspkngkzgmppajnne) and store
-- the service-role key in Vault ONCE (do NOT paste the literal key into a cron body):
--   select vault.create_secret('<service-role-key>', 'service_role_key');
-- (Already done in Session 1 if the Hyperliquid cron is running with Vault.)
