// Deno mirror of src/lib/stats.ts. src/lib/stats.ts is the Vitest-tested SOURCE
// OF TRUTH (stats.test.ts); this copy is for the Edge Function runtime. Keep
...
import { computeNetApr, computeLegDrag, computeSpotLegDrag } from './math.ts'
import {
